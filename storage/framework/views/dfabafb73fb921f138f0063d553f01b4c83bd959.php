              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div id="lista_dobles" class="">
                    <ul class="to_do list">
                    <?php $__currentLoopData = $dobles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li>
                        <p class="nombre">
                           <?php echo e($j->nombre); ?> </p><button class="btn btn-danger btn-xs btnELIMINAR">Eliminar</button>
                      </li>
                  ...
                  <form id="formulario_dobles" action="<?php echo e(url('/admin/listas')); ?>" method="POST">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div id="lista_singles_a" class="">
                    <ul class="to_do list">
                    <?php $__currentLoopData = $a; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li>
                        <p class="nombre">
                           <?php echo e($j->nombre); ?> </p><button class="btn btn-danger btn-xs btnELIMINAR">Eliminar</button>
                      </li>
                  ...
                  <form id="formulario_singles_a" action="<?php echo e(url('/admin/listas')); ?>" method="POST">
                  <?php echo e(csrf_field()); ?>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div id="lista_singles_b" class="">
                    <ul class="to_do list">
                    <?php $__currentLoopData = $b; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li>
                      	
                        <p class="nombre"><?php echo e($j->nombre); ?> </p><button class="btn btn-danger btn-xs btnELIMINAR">Eliminar</button>
                  ...
                  <form id="formulario_singles_b" action="<?php echo e(url('/admin/listas')); ?>" method="POST">
                  <?php echo e(csrf_field()); ?>
