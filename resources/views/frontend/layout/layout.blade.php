...
<!-- Bootstrap -->
<link href="{{asset('/templates/frontend1/')}}/css/bootstrap.min.css" rel="stylesheet">
<link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700,100' rel='stylesheet' type='text/css'>
<link href="{{asset('/templates/frontend1/')}}/css/style.css" rel="stylesheet">
@yield('css')
  ...
  <div class="container">
    <nav class="navbar navbar-default" role="navigation"> 
      ...
      <div class="navbar-header">
        <a href="{{url('/')}}"><img height="80"  class="img-responsive" src="/imagenes/otros/logo4_web.png"></a>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        <h3>Sobre el Club</h3>
        <a href="{{url('')}}"><img  src="{{url('/imagenes/otros/logo4_web.png')}}"></a>
      </div>
      <div class="col-md-6">
        <h3>Fan Page</h3>
        <div class="fb-page"  data-href="https://www.facebook.com/Clubtenislimache/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Clubtenislimache/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Clubtenislimache/">Club de Tenis Limache</a></blockquote></div>
      </div>
      <div class="col-md-3">
        <h3>Info. Contacto</h3>
        <p>Calle Riquelme<br />
...
<script type="text/javascript" src="{{asset('/templates/frontend1/')}}/js/jquery.min.js"></script> 
<!-- Include all compiled plugins (below), or include individual files as needed --> 
<script src="{{asset('/templates/frontend1/')}}/js/bootstrap.min.js"></script> 
